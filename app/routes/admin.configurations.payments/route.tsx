...
import EditPaymentsConfigurations from './components/adminEditPaymentsConfigurations';
import { Configuration } from '@prisma/client';

const PaymentsConfigurations = () => {
...
export default PaymentsConfigurations
