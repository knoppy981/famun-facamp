...
const ChangeRepresentation = ({ state, committee, participationMethod, selectedDelegate, representations }:
  { state: OverlayTriggerState, committee: CommitteeType, participationMethod: ParticipationMethod, selectedDelegate: delegateType, representations: string[] | undefined }
) => {
  const fetcher = useFetcher<any>()
  const [countryArray, country, setCountry, handleSubmission] = useChangeRepresentation(fetcher, state, selectedDelegate, representations)
...
function useChangeRepresentation(fetcher: FetcherWithComponents<any>, state: OverlayTriggerState, selectedDelegate: delegateType, representations: string[] | undefined): [
