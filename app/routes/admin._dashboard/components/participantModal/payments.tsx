...
import ParticipantsListPopover from '~/routes/dashboard.payments.completed/components/paidParticipantsListPopover';
                ...
                <div className={`admin-delegation-notification`} key={index}>
                  <div className='admin-delegation-notification-item'>
                    <PopoverTrigger label={<FiInfo className="icon" />}>
                      <ParticipantsListPopover ids={item?.metadata?.paidUsersIds} />
                    </PopoverTrigger>
