...
const RequiresActionPaymentsWarning = ({ requiresActionPayments }: { requiresActionPayments: RequiresActionPaymentsType }) => {
...
export default RequiresActionPaymentsWarning
