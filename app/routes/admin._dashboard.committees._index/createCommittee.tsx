...
const CreateCommittee = ({ state, participationMethod, councilOptions }: { state: OverlayTriggerState, participationMethod: ParticipationMethod, councilOptions: string[] | undefined }) => {
  const fetcher = useFetcher<any>()
  useCreateCommittee(fetcher, state)
...
function useCreateCommittee(fetcher: FetcherWithComponents<any>, state: OverlayTriggerState) {
  React.useEffect(() => {
